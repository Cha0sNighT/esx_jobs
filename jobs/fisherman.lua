Config.Jobs.fisherman = {
	...
	Zones = {
		CloakRoom = {
			Pos   = {x = 868.39929199219, y = -1639.7556152344, z = 29.349252471924},
		...
		BoatSpawner = {
			Pos   = {x = 3867.44, y = 4463.62, z = 1.73386},
			Size  = {x = 3.0, y = 3.0, z = 1.0},
			Color = {r = 204, g = 204, b = 0},
			Marker= 27,
			Blip  = true,
		...
		VehicleSpawner = {
	       	Pos   = {x = 880.74462890625, y = -1663.9635009766, z = 29.390491027832},
	        Size  = {x = 3.0, y = 3.0, z = 1.0},
	        Color = {r = 204, g = 204, b = 0},
			Marker= 27,
			Blip  = false,
		...
		VehicleSpawnPoint = {
	        Pos   = {x = 859.354, y = -1656.21, z = 29.57697},
	        Size  = {x = 3.0, y = 3.0, z = 1.0},
			Marker= -1,
			Blip  = false,
			Name  = _U('service_vh'),
		...
		VehicleDeletePoint = {
	        Pos   = {x = 863.23254394531, y = -1718.2849121094, z = 28.641998062134},
		...
		Delivery = {
			Pos   = {x = -1012.64758300781, y = -1354.62634277344, z = 5.55292726516724},
			Color = {r = 204, g = 204, b = 0},
			Size  = {x = 5.0, y = 5.0, z = 3.0},
			Color = {r = 204, g = 204, b = 0},
			Marker= 27,
			Blip  = true,
			Name  = _U('fm_deliver_fish_blip'),
			Type  = "delivery",
			Spawner = 2,
			Item  = {
				{
