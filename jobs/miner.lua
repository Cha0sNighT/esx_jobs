Config.Jobs.miner = {
	...
	Zones = {
		CloakRoom = {
			Pos   = {x = 892.35333251953, y = -2172.7705078125, z = 31.296273956299},
		...
		Mine = {
			Pos   = {x = 2962.4, y = 2746.2, z = 42.408},
		...
		StoneWash = {
			Pos   = {x = 289.244, y = 2862.9, z = 42.6524},
			Size  = {x = 5.0, y = 5.0, z = 1.0},
			Color = {r = 204, g = 204, b = 0},
			Marker= 27,
			Blip  = true,
		...
		Foundry = {
			Pos   = {x = 1109.14, y = -2007.87, z = 30.0288},
			Size  = {x = 5.0, y = 5.0, z = 1.0},
			Color = {r = 204, g = 204, b = 0},
			Marker= 27,
			Blip  = true,
		...
		VehicleSpawner = {
			Pos   = {x = 884.86889648438, y = -2176.5102539063, z = 29.529346237183},
			Size  = {x = 5.0, y = 5.0, z = 1.0},
			Color = {r = 204, g = 204, b = 0},
			Marker= 27,
			Blip  = false,
		...
		VehicleDeletePoint = {
			Pos   = {x = 881.93725585938, y = -2198.0151367188, z = 29.529351959229},
			Size  = {x = 5.0, y = 5.0, z = 1.0},
			Color = {r = 255, g = 0, b = 0},
			Marker= 27,
			Blip  = false,
		...
		CopperDelivery = {
			Pos   = {x = -169.481, y = -2659.16, z = 5.01103},
			Color = {r = 204, g = 204, b = 0},
		...
		IronDelivery = {
			Pos   = {x = -148.782, y = -1040.38, z = 26.2836},
			Color = {r = 204, g = 204, b = 0},
			Size  = {x = 5.0, y = 5.0, z = 3.0},
			Color = {r = 204, g = 204, b = 0},
			Marker= 27,
		...
		GoldDelivery = {
			Pos   = {x = 261.487, y = 207.354, z = 109.297},
			Color = {r = 204, g = 204, b = 0},
			Size  = {x = 5.0, y = 5.0, z = 3.0},
			Color = {r = 204, g = 204, b = 0},
			Marker= 27,
		...
		DiamondDelivery = {
			Pos   = {x = -621.046, y = -228.532, z = 37.0671},
			Color = {r = 204, g = 204, b = 0},
			Size  = {x = 5.0, y = 5.0, z = 3.0},
			Color = {r = 204, g = 204, b = 0},
			Marker= 27,
